...
class Boot extends Loggable {
  def boot {
    ...
    MongoAuth.siteName.default.set("LiftScreen Error")
    MongoAuth.systemEmail.default.set("tuhlmann@agynamix.de")
    MongoAuth.systemUsername.default.set("LiftScreen Error")
